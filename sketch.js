...
function draw() {
 background("black");
  ...
  if(arrow.isTouching(pink_balloonGroup),arrow.isTouching(green_balloonGroup),arrow.isTouching(blue_balloonGroup),arrow.isTouching(red_balloonGroup)){
    arrow.destroy(pink_balloonGroup)
    arrow.destroy(green_balloonGroup)
    arrow.destroy(blue_balloonGroup)
    arrow.destroy(red_balloonGroup)
  }
